            ...
            <div className="flex bg-[var(--bg-subtle)] p-1 rounded-[6px] gap-1">
              <button
                ...
                className={`flex-1 py-1.5 text-xs font-medium rounded-[4px] transition-all ${
                  mode === "flashcard" ? "bg-[var(--bg-surface)] shadow-xs text-[var(--text-primary)]" : "text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
                }`}
              >
                Flashcard
              </button>
              <button
                ...
                className={`flex-1 py-1.5 text-xs font-medium rounded-[4px] transition-all ${
                  mode === "notes" ? "bg-[var(--bg-surface)] shadow-xs text-[var(--text-primary)]" : "text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
                }`}
              >
                Revision
              </button>
