  ...
  return (
    <aside className="hidden md:flex flex-col w-[264px] shrink-0 border-r border-[var(--border)] bg-white h-screen sticky top-0 p-5 justify-between select-none">
      <div className="space-y-6">
        <div className="flex items-center justify-between pb-4 border-b border-[var(--border)]">
          <Link href="/admin" className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-[var(--text-primary)] flex items-center justify-center text-white font-black text-sm shadow-sm">N</div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-sm font-extrabold tracking-tight text-[var(--text-primary)]">NoteSprint</span>
                <span className="text-[9px] uppercase font-black tracking-widest px-1.5 py-0.5 rounded-full bg-[var(--bg-subtle)] text-[var(--text-secondary)] border border-[var(--border)]">Admin</span>
              </div>
        ...
        <div className="pt-1">
          <Link href="/dashboard" target="_blank" className="flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-subtle)] border border-transparent hover:border-[var(--border)] transition-colors">
      ...
      <div className="pt-4 border-t border-[var(--border)] space-y-3">
        <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-[var(--bg-subtle)] border border-[var(--border)] text-[11px]">
        ...
        <button type="button" onClick={handleLogout} className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl border border-[var(--border)] hover:bg-[var(--error-subtle)] hover:border-rose-200 text-xs font-bold text-[var(--text-secondary)] hover:text-[var(--error)] transition-colors">
